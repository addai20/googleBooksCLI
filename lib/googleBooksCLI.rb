...
def instructions
  ...
  puts "** To add to reading list, enter a number 0-4 that corresponds to your desired book"
  puts "** To start a new search, enter 5"
  puts "** To view reading list, enter 6"
  puts "** To exit, enter 7"
